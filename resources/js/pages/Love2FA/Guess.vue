            ...
            <div class="relative rounded-2xl overflow-hidden shadow-2xl mb-6">
                ...
                <div class="relative p-8">
                    <div class="text-center mb-6">
                        ...
                        <div class="bg-linear-to-br from-pink-50 to-red-50 rounded-xl p-6 mb-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold"
                                :class="love2fa.remaining_attempts <= 2 ? 'text-red-600' : 'text-gray-900'">
                ...
                <div class="relative p-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid gap-2">
                            ...
                            <Input id="name" v-model="form.name" type="text" required placeholder="e.g., John Doe"
                    ...
                    <div class="mt-6">
                        <div v-if="!showHints && love2fa.hints.length > 0">
                            <Button type="button" @click="viewHints" variant="outline" class="w-full">
                                <Lightbulb class="w-4 h-4 mr-2" />
                                Need a hint? Click here
                            </Button>
                        </div>

                        <div v-else-if="love2fa.hints.length > 0"
                            class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-6">
