...
Route::middleware(AuthenticateWithOtp::class)->group(function () {
    ...
    Route::prefix('love-2fa')->group(function () {
        // Create form
        Route::get('/', [Love2FAController::class, 'create'])->name('love2fa.create')->middleware('throttle:10,1');

        // Store new Love2FA
        Route::post('/', [Love2FAController::class, 'store'])->name('love2fa.store')->middleware('throttle:10,1');
